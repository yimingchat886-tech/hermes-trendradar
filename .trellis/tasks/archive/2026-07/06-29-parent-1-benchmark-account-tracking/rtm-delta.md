...
|---|---|---|
| 5.3 MediaCrawler link into benchmark tracking | P1-REQ-040, P1-REQ-045, P1-REQ-110 | child 8, child 3 |
| 6.1 v1 must do account library, daily tracking, structured capture | P1-REQ-010, P1-REQ-030, P1-REQ-045, P1-REQ-110 | child 1, child 2, child 8, child 3 |
...
| 9.4 video file handling | P1-REQ-060, P1-REQ-065, P1-REQ-110 | child 4, child 8 |
...
| 13.4 competitor-analyst | P1-REQ-040, P1-REQ-060, P1-REQ-065, P1-REQ-070, P1-REQ-110 | child 3, child 4, child 8, child 5 |
| 14.x Feishu tables | P1-REQ-080 | child 6 |
| 17.1 observability | P1-REQ-100 | all children |
| 17.2 traceability | P1-REQ-100 | all children |
| 17.3 cost control and Whisper scope | P1-REQ-065 | child 8 |
| Final local external-runtime smoke test | P1-REQ-110 | child 8 |
...
- Queue/concurrency/daemon external-runtime mode: future work.
- Long-term video storage: excluded by PRDv1.3 section 9.4, not deferred into child 8.
