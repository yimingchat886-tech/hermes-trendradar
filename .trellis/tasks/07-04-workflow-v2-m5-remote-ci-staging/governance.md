...
| M5-3 staging deploy and G6 | Add local-Docker staging deployment path gated on green CI | M5-1, M5-2 | codex | codex/workflow-v2-m4-board | in_progress | TBD |
...
| WV2-M5-REQ-003 | M5-3 staging deploy and G6 | in_progress | 07-04-workflow-v2-m5-3-staging-deploy-g6/stage-report.md |
