...
|---|---|---|---|---|---|---|
| M6-1 claim-guard BLOCK | Flip claim guard to BLOCK; add `task.py claim` / `release`; audit `--override-claim` | M2 G5-WARN, M5 closeout, jym `开启并行` signal received | codex | TBD | planned | TBD |
...
|---|---|---|---|
| WV2-M6-REQ-001 | M6-1 claim-guard BLOCK | planned | TBD |
